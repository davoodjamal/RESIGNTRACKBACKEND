...
class ResignationFormSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'last_working_day', 'immediate_release', 'additional_feedback', 'status'
        ]
    ...
    def save(self, **kwargs):
        ...
        # Extract immediate_release and additional_feedback to store in exit_feedback
        ...
        exit_feedback.setdefault('emergencyReleaseRequested', immediate_release)
        exit_feedback.setdefault('emergencyReason', 'Immediate release requested' if immediate_release else '')
        exit_feedback.setdefault('emergencyRemarks', additional_feedback)
